<template>
  ...
  <div class = "matchBox">
        <div class = 'matchTest'>
            <div class="tag-box">
                <el-check-tag class="tag" :checked="match.checked1" @change="retainedChange('checked1')" size="large">比赛场人数</el-check-tag>
                <el-check-tag class="tag" :checked="match.checked2" @change="retainedChange('checked2')" size="large">比赛场付费人数</el-check-tag>
                <el-check-tag class="tag" :checked="match.checked3" @change="retainedChange('checked3')" size="large">比赛场付费次数</el-check-tag>
                <el-check-tag class="tag" :checked="match.checked4" @change="retainedChange('checked4')" size="large">比赛场付费</el-check-tag>
                <el-check-tag class="tag" :checked="match.checked5" @change="retainedChange('checked5')" size="large">比赛场人arppu</el-check-tag>
                <el-check-tag class="tag" :checked="match.checked6" @change="retainedChange('checked6')" size="large">比赛场付费参透</el-check-tag>
            </div>
            <div class="block">
                <el-date-picker
        ...
        <div id="match" v-show="match.type" style='width:100%; height:300px'></div>
        <div v-show="!match.type" style='width:100%;'>
            <div class="table">
...
export default {
    ...
    watch: {
        'match.matchTime': {
            handler() {
                var {stimedata,etimedata,dayLength} =  this.customDate(this.match.matchTime);
                var customDay = this.customFormatDate(stimedata,etimedata,dayLength);
                this.getmatch(this.activeUsers, customDay);
            }
       }
    },
    methods:{
       ...
       retainedChange(checked) {
            this.match.checked1 = false;
            this.match.checked2 = false;
            this.match.checked3 = false;
            this.match.checked4 = false;
            this.match.checked5 = false;
            this.match.checked6 = false;
            switch (checked) {
                case 'checked1':
                    this.match.checked1 = true;
                    break;
                case 'checked2':
                    this.match.checked2 = true;
                    break;
                case 'checked3':
                    this.match.checked3 = true;
                    break;
                 case 'checked4':
                    this.match.checked4 = true;
                    break;
                case 'checked5':
                    this.match.checked5 = true;
                    break;
                case 'checked6':
                    this.match.checked6 = true;
                    break;
                default:
                    break;
            }
        ...
        formatDate() {
            ...
            this.getmatch(this.fiveOnLine, sevenDay);
        },
        ...
        getmatch(data, day){
            ...
            var chartDom = document.getElementById('match');
