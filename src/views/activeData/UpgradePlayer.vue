<template>
  ...
  <div class = "upgradePlayerBox">
        <div class = 'upgradePlayerTest'>
            <div class="tag-box">
                <el-check-tag class="tag" :checked="upgradePlayer.checked1" @change="retainedChange('checked1')" size="large">升级人数</el-check-tag>
                <el-check-tag class="tag" :checked="upgradePlayer.checked2" @change="retainedChange('checked2')" size="large">升级获得金币</el-check-tag>
                <el-check-tag class="tag" :checked="upgradePlayer.checked3" @change="retainedChange('checked3')" size="large">升级获得钻石</el-check-tag>
                <el-check-tag class="tag" :checked="upgradePlayer.checked4" @change="retainedChange('checked4')" size="large">升级获得老虎机卷</el-check-tag>
                <el-check-tag class="tag" :checked="upgradePlayer.checked5" @change="retainedChange('checked5')" size="large">升级获得比赛场卷</el-check-tag>
            </div>
            <div class="block">
                <el-date-picker
