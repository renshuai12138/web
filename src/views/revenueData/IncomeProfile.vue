<template>
    ...
    <div class = "box">
        <div class = 'test'>
            <div class="tag-box">
                <el-check-tag  class="tag"  :checked="dailyIncome.checked1" @change="onChangeIncome('checked1')" size="large">日收入</el-check-tag>
                <el-check-tag  class="tag"  :checked="dailyIncome.checked2" @change="onChangeIncome('checked2')" size="large">日付费用户数</el-check-tag>
                <el-check-tag  class="tag"  :checked="dailyIncome.checked3" @change="onChangeIncome('checked3')" size="large">日arppu</el-check-tag>
                <el-check-tag  class="tag"  :checked="dailyIncome.checked4" @change="onChangeIncome('checked4')" size="large">日付费渗透</el-check-tag>
                <el-check-tag  class="tag"  :checked="dailyIncome.checked5" @change="onChangeIncome('checked5')" size="large">日付费次数</el-check-tag>
                <el-check-tag  class="tag"  :checked="dailyIncome.checked6" @change="onChangeIncome('checked6')" size="large">H5日收入</el-check-tag>
                <el-check-tag  class="tag"  :checked="dailyIncome.checked7" @change="onChangeIncome('checked7')" size="large">H5日付费用户数</el-check-tag>
                <el-check-tag  class="tag"  :checked="dailyIncome.checked8" @change="onChangeIncome('checked8')" size="large">H5arppu</el-check-tag>
                <el-check-tag  class="tag"  :checked="dailyIncome.checked9" @change="onChangeIncome('checked9')" size="large">H5日付费渗透</el-check-tag>
                <el-check-tag  class="tag"  :checked="dailyIncome.checked10" @change="onChangeIncome('checked10')" size="large">H5日付费次数</el-check-tag>
            </div>
            <div class="block">
                <el-date-picker
    ...
    <div class = "box">
        <div class = 'test'>
            <div class="tag-box">
                <el-check-tag  class="tag"  :checked="dailyIncomeP.checked1" @change="onChangeIncomeP('checked1')" size="large">日收入-安装平台</el-check-tag>
                <el-check-tag  class="tag"  :checked="dailyIncomeP.checked2" @change="onChangeIncomeP('checked2')" size="large">日付费用户数</el-check-tag>
                <el-check-tag  class="tag"  :checked="dailyIncomeP.checked3" @change="onChangeIncomeP('checked3')" size="large">日Arppu</el-check-tag>
                <el-check-tag  class="tag"  :checked="dailyIncomeP.checked4" @change="onChangeIncomeP('checked4')" size="large">日付费渗透</el-check-tag>
                <el-check-tag  class="tag"  :checked="dailyIncomeP.checked5" @change="onChangeIncomeP('checked5')" size="large">日付费次数</el-check-tag>
            </div>
            <div class="block">
                <el-date-picker
    ...
    <div class = "box">
        <div class = 'test'>
            <div class="tag-box">
                <el-check-tag  class="tag"  :checked="paidRetention.checked1" @change="onChangeRetention('checked1')" size="large">日付费留存</el-check-tag>
                <el-check-tag  class="tag"  :checked="paidRetention.checked2" @change="onChangeRetention('checked2')" size="large">日付费留存率</el-check-tag>
                <el-check-tag  class="tag"  :checked="paidRetention.checked3" @change="onChangeRetention('checked3')" size="large">H5日付费留存</el-check-tag>
                <el-check-tag  class="tag"  :checked="paidRetention.checked4" @change="onChangeRetention('checked4')" size="large">H5日付费留存率</el-check-tag>
            </div>
            <div class="block">
                <el-date-picker
    ...
    <div class = "box">
        <div class = 'test'>
            <div class="tag-box">
                <el-check-tag  class="tag"  :checked="monthlyIncome.checked1" @change="onChangeMonthly('checked1')" size="large">月收入</el-check-tag>
                <el-check-tag  class="tag"  :checked="monthlyIncome.checked2" @change="onChangeMonthly('checked2')" size="large">月付费用户数</el-check-tag>
                <el-check-tag  class="tag"  :checked="monthlyIncome.checked3" @change="onChangeMonthly('checked3')" size="large">月arppu</el-check-tag>
                <el-check-tag  class="tag"  :checked="monthlyIncome.checked4" @change="onChangeMonthly('checked4')" size="large">月付费渗透</el-check-tag>
                <el-check-tag  class="tag"  :checked="monthlyIncome.checked5" @change="onChangeMonthly('checked5')" size="large">H5月收入</el-check-tag>
                <el-check-tag  class="tag"  :checked="monthlyIncome.checked6" @change="onChangeMonthly('checked6')" size="large">H5月付费用户数</el-check-tag>
                <el-check-tag  class="tag"  :checked="monthlyIncome.checked7" @change="onChangeMonthly('checked7')" size="large">H5月arppu</el-check-tag>
                <el-check-tag  class="tag"  :checked="monthlyIncome.checked8" @change="onChangeMonthly('checked8')" size="large">H5月付费渗透</el-check-tag>
            </div>
            <div class="block">
                <el-date-picker
    ...
    <div class = "box">
        <div class = 'test'>
            <div class="tag-box">
                <el-check-tag  class="tag"  :checked="arppu.checked1" @change="onChangeArppu('checked1')" size="large">Arppu-VIP.0</el-check-tag>
                <el-check-tag  class="tag"  :checked="arppu.checked2" @change="onChangeArppu('checked2')" size="large">VIP.1</el-check-tag>
                <el-check-tag  class="tag"  :checked="arppu.checked3" @change="onChangeArppu('checked3')" size="large">VIP.2</el-check-tag>
                <el-check-tag  class="tag"  :checked="arppu.checked4" @change="onChangeArppu('checked4')" size="large">VIP.3</el-check-tag>
                <el-check-tag  class="tag"  :checked="arppu.checked5" @change="onChangeArppu('checked5')" size="large">VIP.4</el-check-tag>
                <el-check-tag  class="tag"  :checked="arppu.checked6" @change="onChangeArppu('checked6')" size="large">VIP.5</el-check-tag>
                <el-check-tag  class="tag"  :checked="arppu.checked7" @change="onChangeArppu('checked7')" size="large">VIP.6</el-check-tag>
                <el-check-tag  class="tag"  :checked="arppu.checked8" @change="onChangeArppu('checked8')" size="large">VIP.7</el-check-tag>
                <el-check-tag  class="tag"  :checked="arppu.checked9" @change="onChangeArppu('checked9')" size="large">VIP.8</el-check-tag>
                <el-check-tag  class="tag"  :checked="arppu.checked10" @change="onChangeArppu('checked10')" size="large">VIP.9</el-check-tag>
            </div>
            <div class="block">
                <el-date-picker
                    v-model="arppu.Time"
