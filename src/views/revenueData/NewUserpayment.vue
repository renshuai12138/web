<template>
  ...
  <div class = "upgradePlayerBox">
        <div class = 'upgradePlayerTest'>
            <div class="tag-box">
                <el-check-tag class="tag" :checked="upgradePlayer.checked1" @change="retainedChange('checked1')" size="large">日收入-安装平台</el-check-tag>
                <el-check-tag class="tag" :checked="upgradePlayer.checked2" @change="retainedChange('checked2')" size="large">日付费用户数</el-check-tag>
                <el-check-tag class="tag" :checked="upgradePlayer.checked3" @change="retainedChange('checked3')" size="large">日Arppu</el-check-tag>
                <el-check-tag class="tag" :checked="upgradePlayer.checked4" @change="retainedChange('checked4')" size="large">日付费渗透</el-check-tag>
                <el-check-tag class="tag" :checked="upgradePlayer.checked5" @change="retainedChange('checked5')" size="large">日付费次数</el-check-tag>
            </div>
            <div class="block">
                <el-date-picker
