<template>
    ...
    <div class = "diamondsBox">
            <div class = 'diamondsTest'>
                <div class="tag-box">
                    <el-check-tag class="tag" :checked="diamonds.checked1" @change="retainedChange('checked1')" size="large">钻石产出-支付</el-check-tag>
                    <el-check-tag class="tag" :checked="diamonds.checked2" @change="retainedChange('checked2')" size="large">钻石产出-邮件</el-check-tag>
                    <el-check-tag class="tag" :checked="diamonds.checked3" @change="retainedChange('checked3')" size="large">钻石产出-Gm</el-check-tag>
                    <el-check-tag class="tag" :checked="diamonds.checked4" @change="retainedChange('checked4')" size="large">钻石消耗-老虎机</el-check-tag>
                </div>
                <div class="block">
                    <el-date-picker
            ...
            <div id="diamonds" v-show="diamonds.type"  style=' width:100%; height:300px'></div>
    ...
    watch: {
        'diamonds.diamondsTime': {
            handler() {
                ...
                this.getdiamonds(this.activeUsers, customDay);
            }
       }
    },
    methods:{
       ...
       retainedChange(checked) {
            this.diamonds.checked1 = false;
            this.diamonds.checked2 = false;
            this.diamonds.checked3 = false;
            this.diamonds.checked4 = false;
            this.diamonds.checked5 = false;
            switch (checked) {
                case 'checked1':
                    this.diamonds.checked1 = true;
                    break;
                case 'checked2':
                    this.diamonds.checked2 = true;
                    break;
                case 'checked3':
                    this.diamonds.checked3 = true;
                    break;
                 case 'checked4':
                    this.diamonds.checked4 = true;
                    break;
                case 'checked5':
                    this.diamonds.checked5 = true;
                    break;
                default:
                    break;
            }
        ...
        formatDate() {
            ...
            this.getdiamonds(this.fiveOnLine, sevenDay);
        },
